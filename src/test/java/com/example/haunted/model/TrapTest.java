...
class TrapTest {
    ...
    @DisplayName("Constructor stores all fields exactly as provided")
    ...
    @DisplayName("All TrapType enum values are accepted")
    ...
    void nullNameThrows() {
        assertThrows(NullPointerException.class,
                () -> new Trap(null, TrapType.ELECTRIC, 5, true, true));
    }
    ...
    @Test
    @DisplayName("disarm() on already-unarmed trap stays unarmed (idempotent)")
